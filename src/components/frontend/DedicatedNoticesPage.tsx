              ...
              >
                ...
                <div className="shrink-0 flex items-center gap-2 self-end sm:self-center">
                  <button
                    ...
                    className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-emerald-50 hover:bg-[#15803d] text-emerald-800 hover:text-white font-semibold text-xs transition cursor-pointer"
                  >
            ...
            {currentNotices.map((notice) => (
              ...
              >
                ...
                <div className="mt-4 pt-4 border-t border-gray-100 flex items-center justify-between text-xs">
                  ...
                  <span className="inline-flex items-center gap-1 font-bold text-emerald-700 group-hover:text-emerald-900">
                    <span>পড়ুন</span>
      ...
      {selectedNotice && (
        <div className="fixed inset-0 z-50 bg-black/60 backdrop-blur-xs flex items-center justify-center p-3 sm:p-6 overflow-y-auto">
          <div className="bg-white rounded-3xl max-w-2xl w-full p-6 sm:p-8 shadow-2xl relative border border-gray-100 my-8">
            ...
            <div className="flex items-center justify-between pt-4 border-t border-gray-100 print:hidden text-xs">
              <button
                type="button"
                onClick={handlePrintModal}
                className="inline-flex items-center gap-1.5 px-4 py-2 bg-emerald-700 hover:bg-emerald-800 text-white rounded-xl font-bold transition cursor-pointer shadow-xs"
              >
